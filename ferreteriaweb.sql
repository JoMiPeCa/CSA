...
INSERT INTO PRODUCTO VALUES('1',' EJE DEL EMBRAGUE','MOBILIARIO DE JARDÍN',26240,'SIN DESCRIPCIÓN DISPONIBLE','MYI6381',22,0,'');
INSERT INTO PRODUCTO VALUES('2',' SET VASTAGO Y RODAMIENTOS V: 50/68 MM., R: 125/170/200 MM.,  (P/RCB-25)','FERRETERÍA GENERAL',329640,'SIN DESCRIPCIÓN DISPONIBLE','UWQ2930',3,0,'');
INSERT INTO PRODUCTO VALUES('3',' BISAGRA FIERRO CINCADO   2"   X  1.0 MM.','PARA MUEBLES',110,'SIN DESCRIPCIÓN DISPONIBLE','AJE3642',91,0,'');
INSERT INTO PRODUCTO VALUES('4',' JUNTA PARA PT2636','GRIFERÍA',1082,'SIN DESCRIPCIÓN DISPONIBLE','QOJ8754',21,0,'');
INSERT INTO PRODUCTO VALUES('5',' JGO DESTORNILLADORES MANGO ERGONIC DE 5 PIEZAS, 3 PLANOS 4,0 X 100, 5,5 X 125, 6,5 X 150, Y 2 CRUZ PH1 X 80, PH2 X 100','HERRAMIENTA ELÉCTRICA',24375,'SIN DESCRIPCIÓN DISPONIBLE','LZV9360',8,0,'');
INSERT INTO PRODUCTO VALUES('6',' DADO []1/2" POLIGONAL DE 12 MM.','HERRAMIENTAS',1493,'SIN DESCRIPCIÓN DISPONIBLE','OUZ5329',89,0,'');
INSERT INTO PRODUCTO VALUES('7',' NAPOLEON CORTACABLE COBRE ALUMINIO ACERO DE 20 MM.','MOBILIARIO DE COCINA',289914,'SIN DESCRIPCIÓN DISPONIBLE','SUA9568',82,0,'');
INSERT INTO PRODUCTO VALUES('8',' ESPACIADOR PARA PT326','PARA OBRA Y DECORACIÓN',647,'SIN DESCRIPCIÓN DISPONIBLE','USB2852',97,0,'');
INSERT INTO PRODUCTO VALUES('9',' ESCARIADOR CONICO A/R 20 MM.','SANITARIOS Y LAVADOS',36690,'SIN DESCRIPCIÓN DISPONIBLE','MJL2137',15,0,'');
INSERT INTO PRODUCTO VALUES('10',' PISTOLA DE ALTA PRESION 4001B, GRAVEDAD, PRESION DE TRABAJO 50-80 PSI, CONSUMO DE AIRE 7-12 PSI, DEPOSITO PLASTICO 600 CC. BOQUILLA PASO 1,7MM','PEQUEÑO ELECTRODOMÉSTICO',15450,'SIN DESCRIPCIÓN DISPONIBLE','KPS5775',12,0,'');
INSERT INTO PRODUCTO VALUES('11',' VIDRIO OSCURO REDONDO 50 MM GRADO 5','SANITARIOS Y LAVADOS',110,'SIN DESCRIPCIÓN DISPONIBLE','QEV3111',22,0,'');
INSERT INTO PRODUCTO VALUES('12',' ESPATULA FLEXIBLE BIMAT. AC/INOX. 150 MM','MOBILIARIO DE JARDÍN',4432,'SIN DESCRIPCIÓN DISPONIBLE','CSU2412',72,0,'');
INSERT INTO PRODUCTO VALUES('13',' BROCA CONO MORSE A/R 49.00 MM.','MOBILIARIO DE JARDÍN',219465,'SIN DESCRIPCIÓN DISPONIBLE','PFK6259',22,0,2,'2016-07-03');
INSERT INTO PRODUCTO VALUES('14',' PLANA ALBAÑIL PUNTA 125 X  70  MM.','ACCESORIOS DE BAÑO',11600,'SIN DESCRIPCIÓN DISPONIBLE','CCS3668',76,0,'');
INSERT INTO PRODUCTO VALUES('15',' THROTTLE VALVE SEAT','ACCESORIOS DE BAÑO',850,'SIN DESCRIPCIÓN DISPONIBLE','IPT1336',61,0,'');
INSERT INTO PRODUCTO VALUES('16',' CABEZAL 1/4" BSPT TERRAJA OOR','EQUIPAMIENTO DE HABITACIONES',87980,'SIN DESCRIPCIÓN DISPONIBLE','JDQ3884',26,0,'');
INSERT INTO PRODUCTO VALUES('17',' LIMA PLANA 2º CORTE DE  4"','SANITARIOS Y LAVADOS',2412,'SIN DESCRIPCIÓN DISPONIBLE','YSZ1571',94,0,'');
INSERT INTO PRODUCTO VALUES('18',' BROCA CONCRETO 20X 240/300 SDS-PLUS','FERRETERÍA GENERAL',7862,'SIN DESCRIPCIÓN DISPONIBLE','FST1439',46,0,'');
INSERT INTO PRODUCTO VALUES('19',' PANEL FRONTAL PARA #488','HERRAMIENTAS',112308,'SIN DESCRIPCIÓN DISPONIBLE','EGH1757',88,0,'');
INSERT INTO PRODUCTO VALUES('20',' LIJADORA DE HOJA 1/4",  POTENCIA 220 W., VELOC. ORBITAL 16000 OPM., OSCILACION: 32000 OPM.,  MEDIDA 114 X 140 MM. CON RECOLECTOR DE POLVO','METALISTERÍA',29024,'SIN DESCRIPCIÓN DISPONIBLE','QNW2711',71,0,14,'2016-07-03');
INSERT INTO PRODUCTO VALUES('21',' SIERRA COPA MULTI MADERA    1"  (25 MM.)','PEQUEÑO ELECTRODOMÉSTICO',5088,'SIN DESCRIPCIÓN DISPONIBLE','XBP5578',31,0,'');
INSERT INTO PRODUCTO VALUES('22',' ESPIGA P/UNION MANGUERAS  3/8" X 3/8"','MOBILIARÍO DE BAÑO',1237,'SIN DESCRIPCIÓN DISPONIBLE','JDC1348',87,0,'');
INSERT INTO PRODUCTO VALUES('23',' GUADAÑA MOD. ANCHO DE 22" J 115 FORJADAS A MANO','SANITARIOS Y LAVADOS',23750,'SIN DESCRIPCIÓN DISPONIBLE','KTY4246',27,0,'');
INSERT INTO PRODUCTO VALUES('24',' CONJUNTO EJE IV CON RODAMIENTOS','HERRAMIENTA ELÉCTRICA',66580,'SIN DESCRIPCIÓN DISPONIBLE','GTU4246',91,0,'');
INSERT INTO PRODUCTO VALUES('25',' ALICATE UNIVERSAL 7" MANGO NEGRO BLISTER','CERRAJERÍA',1767,'SIN DESCRIPCIÓN DISPONIBLE','PZK8274',61,0,'');
INSERT INTO PRODUCTO VALUES('26',' DESTORNILLADOR NEUMATICO HEAVY DUTY, TORQUE FIJO 145 LB/PULG-16 NM, VELOCIDAD 800 RPM, PINZA DE 1/4", CONSUMO DE AIRE 114 LT/MIN, ENTRADA AIRE 1/4", PESO 1,2K','CERRAJERÍA',64605,'SIN DESCRIPCIÓN DISPONIBLE','YUZ3295',95,0,'');
INSERT INTO PRODUCTO VALUES('27',' PINCELES A- 2','PEQUEÑO ELECTRODOMÉSTICO',653,'SIN DESCRIPCIÓN DISPONIBLE','OKK3365',82,0,24,'2016-07-03');
INSERT INTO PRODUCTO VALUES('28',' BARRA DE CABEZAL MODULO B','PARA OBRA Y DECORACIÓN',284400,'SIN DESCRIPCIÓN DISPONIBLE','FWG6458',21,0,'');
INSERT INTO PRODUCTO VALUES('29',' AZADA CON ENCAJE DE MANGO SOLDADO  7" DE 90 X 179 MM.','UTENSILIOS Y COMPLEMENTOS',4167,'SIN DESCRIPCIÓN DISPONIBLE','NAL2198',91,0,06,'2016-07-03');
INSERT INTO PRODUCTO VALUES('30',' TALADRO NEUMATICO DE 1/2" HEAVY DUTY REVERSIBLE, VELOCIDAD 800 RPM, CONSUMO DE AIRE 110 LT/MIN, ENTRADA DE AIRE 1/4" PESO 1,80 KGS.','HERRAMIENTA ELÉCTRICA',71685,'SIN DESCRIPCIÓN DISPONIBLE','LPM7823',64,0,'');
INSERT INTO PRODUCTO VALUES('31',' TALADRO DE COLUMNA 1.5 HP, 380 VOLTS, PARA BROCA HASTA 1.1/4",  12 VELOCIDADES','ELECTRODOMÉSTICO',525770,'SIN DESCRIPCIÓN DISPONIBLE','FOH5583',19,0,'');
INSERT INTO PRODUCTO VALUES('32',' PASADOR DEL MARTILLO PARA PT5124','ARTÍCULOS DE JARDÍN',3164,'SIN DESCRIPCIÓN DISPONIBLE','UJD2545',85,0,'');
INSERT INTO PRODUCTO VALUES('33',' RACORD ACOPLE RAPIDO HILO MACHO DE 1/4"','ACCESORIOS DE BAÑO',270,'SIN DESCRIPCIÓN DISPONIBLE','QDD1292',41,0,'');
INSERT INTO PRODUCTO VALUES('34',' GATILLO PISTOLIN DE ACEITE','ELECTRODOMÉSTICO',5934,'SIN DESCRIPCIÓN DISPONIBLE','EUB5101',99,0,'');
INSERT INTO PRODUCTO VALUES('35',' TECLE ELECTRICO MONOFASICO 0.5 T X 6 MT.','CERRAJERÍA',900750,'SIN DESCRIPCIÓN DISPONIBLE','VRE8326',93,0,'');
INSERT INTO PRODUCTO VALUES('36',' INFLADOR DE NEUMATICOS CON MANOMETRO DE BARRA DE 10 A 120 PSI, 1.0 A 8.0 BAR EN METAL, DOBLE TOMA, ENTRADA DE 1/4", EN BLISTER','CERRAJERÍA',23906,'SIN DESCRIPCIÓN DISPONIBLE','EIR8663',12,0,'');
INSERT INTO PRODUCTO VALUES('37',' CERRADURA TUBULAR DE POMO  #578 SOLO POMO EXTERIOR SIN LLAVE, CROMADA','UTENSILIOS Y COMPLEMENTOS',1650,'SIN DESCRIPCIÓN DISPONIBLE','GXC3890',38,0,'');
INSERT INTO PRODUCTO VALUES('38',' BROCA CILINDRICA A/R 25.0  MM.','MOBILIARÍO DE BAÑO',88484,'SIN DESCRIPCIÓN DISPONIBLE','EJA8317',62,0,'');
INSERT INTO PRODUCTO VALUES('39',' BIELA','EQUIPAMIENTO DE JARDÍN',902,'SIN DESCRIPCIÓN DISPONIBLE','IUQ5555',42,0,'');
INSERT INTO PRODUCTO VALUES('40',' MUELA DE    1"    P/DOBLADORA DE TUBOS','PARA OBRA Y DECORACIÓN',80160,'SIN DESCRIPCIÓN DISPONIBLE','VRN7888',53,0,'');
