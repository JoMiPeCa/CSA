...
-- -----------------------------------------------------
INSERT IGNORE INTO USUARIO VALUES('74351336','MARIA','TOLEDO ESCOBAR','MUJER','1987-01-30',984885450,'MTOLEDO.ES@FACEBOOK.COM',FALSE,'1234');
INSERT IGNORE INTO USUARIO VALUES('78482796','ERIKA','MILLAS GONZALEZ','MUJER','1982-12-22',986921326,'EMILLAS.GO@YAHOO.COM',FALSE,'47fa7b241cb1b4f35722abaa302aa593');
INSERT IGNORE INTO USUARIO VALUES('85112244','RODRIGO','MORAGA VARGAS','HOMBRE','1983-12-17',984635896,'RMORAGA.VA@FACEBOOK.COM',FALSE,'1db41f6f96f232d888bd59a42d354fa8');
INSERT IGNORE INTO USUARIO VALUES('85188046','MARIA','QUIROZ BRAVO','MUJER','1980-10-15',975631686,'MQUIROZ.BR@OUTLOOK.ES',FALSE,'4a3b00cd6053326df6cabfc0d4037de9');
INSERT IGNORE INTO USUARIO VALUES('90651110','PATRICIA','ALBORNOZ VICUÑA','MUJER','1981-05-19',983513455,'PALBORNOZ.VI@GMAIL.COM',TRUE,'2fc72acaa7f64b6e4c33fc98f576b8ea');
INSERT IGNORE INTO USUARIO VALUES('91970856','LUIS','CESPEDES FUENTES','HOMBRE','1987-11-25',990406046,'LCESPEDES.FU@OUTLOOK.ES',TRUE,'9c5057c775276e741e05986eef5e9164');
INSERT IGNORE INTO USUARIO VALUES('94561485','WALDO','TAPIA TAPIA','HOMBRE','1980-10-17',969916058,'WTAPIA.TA@GMAIL.COM',FALSE,'1337dc4d8862472936ba4b994e6246d6');
INSERT IGNORE INTO USUARIO VALUES('101081281','RODOLFO','VELASQUEZ SANTOS','HOMBRE','1986-02-07',964682316,'RVELASQUEZ.SA@OUTLOOK.ES',FALSE,'e1880e4f9b6c70dd9da401e6f2ccd0a1');
INSERT IGNORE INTO USUARIO VALUES('104254551','ARMANDO','MORENO GAMBOA','HOMBRE','1983-03-26',973731839,'AMORENO.GA@HOTMAIL.COM',TRUE,'75fe2b82fa2aa8f949958f52d21710b9');
INSERT IGNORE INTO USUARIO VALUES('109753122','LORENA','RAMÍREZ AHUMADA','MUJER','1988-11-07',973406640,'LRAMÍREZ.AH@OUTLOOK.ES',FALSE,'46577e3803a3896dbe65fc41e1f41293');
INSERT IGNORE INTO USUARIO VALUES('112881956','JUANA','GUTIERREZ CARDENAS','MUJER','1983-06-15',988489114,'JGUTIERREZ.CA@FACEBOOK.COM',TRUE,'64c3b87cb55496d931960684481b2518');
INSERT IGNORE INTO USUARIO VALUES('118978013','NELSON','LAGOS PADILLA','HOMBRE','1995-03-12',984834027,'NLAGOS.PA@YAHOO.COM',FALSE,'987a9c010b6ac5e4e9d07b78b0a0418c');
INSERT IGNORE INTO USUARIO VALUES('119701759','DENISSE','VERA ASTORGA','MUJER','1985-09-30',961304052,'DVERA.AS@HOTMAIL.COM',TRUE,'19c36e07ed2b9bd5ee2f1561f0df6b3c');
INSERT IGNORE INTO USUARIO VALUES('121128055','RITA','JIMENEZ VITALJIC','MUJER','1990-03-02',968272228,'RJIMENEZ.VI@GMAIL.COM',FALSE,'ef6bbe768a53b1fe9e3402e7a4f17255');
INSERT IGNORE INTO USUARIO VALUES('124872847','CARMEN','JARA GUZMAN','MUJER','1989-02-10',998537329,'CJARA.GU@FACEBOOK.COM',TRUE,'a84d1d67b8bd80e1ad522e1d6198b2b1');
INSERT IGNORE INTO USUARIO VALUES('125474330','CHRISTIAN','GARRIDO GARRIDO','HOMBRE','1992-11-18',969316324,'CGARRIDO.GA@FACEBOOK.COM',FALSE,'044e3e493b40654cdc8bfdba9784768e');
INSERT IGNORE INTO USUARIO VALUES('126031661','ERIKA','ROZAS LUNA','MUJER','1988-11-28',961984154,'EROZAS.LU@HOTMAIL.COM',TRUE,'823dc358df875a190984fafdd6c8b7c9');
INSERT IGNORE INTO USUARIO VALUES('127192898','VERONICA','MUÑOZ MESA','MUJER','1980-03-19',985139498,'VMUÑOZ.ME@GMAIL.COM',FALSE,'0354827c39c36e64fb918c1d8f97a51c');
INSERT IGNORE INTO USUARIO VALUES('128249834','CAROLA','GONZALES SEPULVEDA','MUJER','1986-02-04',978993854,'CGONZALES.SE@OUTLOOK.ES',TRUE,'74d8b0c0b2b05a1a46d33d14eff7ae57');
-- -----------------------------------------------------
-- CATEGORIA
-- -----------------------------------------------------
